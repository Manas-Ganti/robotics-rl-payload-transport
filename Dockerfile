# =============================================================================
# Dockerfile -- A100 runtime for robust-transport-nav
# =============================================================================
...
#
# VERIFY ON A100 (before a long run):
...
# VERIFY ON A100: pin to the Isaac Sim release your Isaac Lab checkout targets.
